...
TNode<Object> LoadTuple3Value1_0(compiler::CodeAssemblerState* state_, TNode<Tuple3> p_o) {
  ...
  if (block0.is_used()) {
    TNode<Tuple3> tmp0;
    ca_.Bind(&block0, &tmp0);
    TNode<IntPtrT> tmp1 = ca_.IntPtrConstant(Tuple3::kValue1Offset);
    USE(tmp1);
    TNode<Object>tmp2 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp0, tmp1});
    ca_.Goto(&block2, tmp0, tmp2);
  }
...
void StoreTuple3Value1_0(compiler::CodeAssemblerState* state_, TNode<Tuple3> p_o, TNode<Object> p_v) {
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp1;
    ca_.Bind(&block0, &tmp0, &tmp1);
    TNode<IntPtrT> tmp2 = ca_.IntPtrConstant(Tuple3::kValue1Offset);
    USE(tmp2);
    CodeStubAssembler(state_).StoreReference(CodeStubAssembler::Reference{tmp0, tmp2}, tmp1);
    ca_.Goto(&block2, tmp0, tmp1);
  }
...
TNode<Object> LoadTuple3Value2_0(compiler::CodeAssemblerState* state_, TNode<Tuple3> p_o) {
  ...
  if (block0.is_used()) {
    TNode<Tuple3> tmp0;
    ca_.Bind(&block0, &tmp0);
    TNode<IntPtrT> tmp1 = ca_.IntPtrConstant(Tuple3::kValue2Offset);
    USE(tmp1);
    TNode<Object>tmp2 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp0, tmp1});
    ca_.Goto(&block2, tmp0, tmp2);
  }
...
void StoreTuple3Value2_0(compiler::CodeAssemblerState* state_, TNode<Tuple3> p_o, TNode<Object> p_v) {
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp1;
    ca_.Bind(&block0, &tmp0, &tmp1);
    TNode<IntPtrT> tmp2 = ca_.IntPtrConstant(Tuple3::kValue2Offset);
    USE(tmp2);
    CodeStubAssembler(state_).StoreReference(CodeStubAssembler::Reference{tmp0, tmp2}, tmp1);
    ca_.Goto(&block2, tmp0, tmp1);
  }
