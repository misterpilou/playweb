...
void Method_JSPromise_SetStatus_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_this, Promise::PromiseState p_status) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp2 = ca_.IntPtrConstant(JSPromise::kFlagsOffset);
    USE(tmp2);
    TNode<IntPtrT> tmp3 = ca_.IntPtrConstant(JSPromise::kFlagsOffset);
    USE(tmp3);
    ...
    CodeStubAssembler(state_).StoreReference(CodeStubAssembler::Reference{tmp0, tmp2}, tmp5);
  ...
  if (block5.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'this.Status() == kPromisePending' failed", "src/objects/js-promise.tq", 22);
  }
  ...
  if (block9.is_used()) {
    ...
    CodeStubAssembler(state_).FailAssert("Torque assert 'status != kPromisePending' failed", "src/objects/js-promise.tq", 23);
  }
...
void Method_JSPromise_SetHasHandler_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_this) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference(CodeStubAssembler::Reference{tmp0, tmp1}, tmp4);
