...
TNode<Object> ReduceRightAllElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialValue) {
  ...
  if (block15.is_used()) {
    ...
    TNode<Object> tmp74;
    USE(tmp74);
    tmp74 = CodeStubAssembler(state_).Call(TNode<Context>{tmp59}, TNode<JSReceiver>{tmp61}, TNode<Object>{tmp72}, TNode<Object>{ca_.UncheckedCast<Object>(tmp70)}, TNode<Object>{tmp69}, TNode<Object>{tmp73}, TNode<Object>{tmp63});
