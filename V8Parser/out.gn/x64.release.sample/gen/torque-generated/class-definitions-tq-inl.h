...
template <class D, class P>
ByteArray TorqueGeneratedSourcePositionTableWithFrameCache<D, P>::source_position_table(const Isolate* isolate) const {
...
template <class D, class P>
Object TorqueGeneratedSourcePositionTableWithFrameCache<D, P>::stack_frame_cache(const Isolate* isolate) const {
...
template <class D, class P>
Object TorqueGeneratedWeakCell<D, P>::key() const {
  const Isolate* isolate = GetIsolateForPtrCompr(*this);
  return TorqueGeneratedWeakCell::key(isolate);
}
template <class D, class P>
Object TorqueGeneratedWeakCell<D, P>::key(const Isolate* isolate) const {
  Object value = TaggedField<Object, kKeyOffset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
void TorqueGeneratedWeakCell<D, P>::set_key(Object value, WriteBarrierMode mode) {
  SLOW_DCHECK(value.IsHeapObject() || value.IsSmi());
  WRITE_FIELD(*this, kKeyOffset, value);
  CONDITIONAL_WRITE_BARRIER(*this, kKeyOffset, value, mode);
}
...
template <class D, class P>
Object TorqueGeneratedTuple3<D, P>::value1() const {
  const Isolate* isolate = GetIsolateForPtrCompr(*this);
  return TorqueGeneratedTuple3::value1(isolate);
}
template <class D, class P>
Object TorqueGeneratedTuple3<D, P>::value1(const Isolate* isolate) const {
  Object value = TaggedField<Object, kValue1Offset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
void TorqueGeneratedTuple3<D, P>::set_value1(Object value, WriteBarrierMode mode) {
  SLOW_DCHECK(value.IsHeapObject() || value.IsSmi());
  WRITE_FIELD(*this, kValue1Offset, value);
  CONDITIONAL_WRITE_BARRIER(*this, kValue1Offset, value, mode);
}
...
template <class D, class P>
Object TorqueGeneratedTuple3<D, P>::value2() const {
  const Isolate* isolate = GetIsolateForPtrCompr(*this);
  return TorqueGeneratedTuple3::value2(isolate);
}
template <class D, class P>
Object TorqueGeneratedTuple3<D, P>::value2(const Isolate* isolate) const {
  Object value = TaggedField<Object, kValue2Offset>::load(isolate, *this);
  DCHECK(value.IsHeapObject() || value.IsSmi());
  return value;
}
template <class D, class P>
void TorqueGeneratedTuple3<D, P>::set_value2(Object value, WriteBarrierMode mode) {
  SLOW_DCHECK(value.IsHeapObject() || value.IsSmi());
  WRITE_FIELD(*this, kValue2Offset, value);
  CONDITIONAL_WRITE_BARRIER(*this, kValue2Offset, value, mode);
}
...
template <class D, class P>
Object TorqueGeneratedTuple3<D, P>::value3(const Isolate* isolate) const {
